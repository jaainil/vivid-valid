...
const MAX_BULK_EMAILS = parseInt(import.meta.env.VITE_MAX_BULK_EMAILS || "1000");
const MAX_FILE_SIZE = parseInt(import.meta.env.VITE_MAX_FILE_SIZE || "10485760"); // 10MB in bytes
const SUPPORTED_FILE_TYPES = import.meta.env.VITE_SUPPORTED_FILE_TYPES || ".csv,.txt";

// App Configuration
const APP_NAME = import.meta.env.VITE_APP_NAME || "Email Verifier Pro";
