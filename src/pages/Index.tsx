        ...
        <div className="text-center mb-12 animate-slide-up">
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-12">
            <Card className="glass-card p-6 text-center hover:scale-105 transition-all duration-300">
              ...
              <p className="text-sm text-muted-foreground">Real-time verification with instant results</p>
            </Card>
            
            <Card className="glass-card p-6 text-center hover:scale-105 transition-all duration-300">
              <CheckCircle className="h-8 w-8 text-success mx-auto mb-4" />
              <h3 className="font-semibold mb-2">99.9% Accurate</h3>
              <p className="text-sm text-muted-foreground">Advanced SMTP validation & domain checking</p>
            </Card>
            
            <Card className="glass-card p-6 text-center hover:scale-105 transition-all duration-300">
              <Users className="h-8 w-8 text-primary mx-auto mb-4" />
              <h3 className="font-semibold mb-2">Bulk Processing</h3>
              <p className="text-sm text-muted-foreground">Process thousands of emails with CSV/TXT upload</p>
            </Card>
          </div>
        </div>
        ...
        <Card className="glass-card p-8 max-w-4xl mx-auto">
          <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
            <TabsList className="grid w-full grid-cols-2 mb-8">
              <TabsTrigger value="single" className="data-[state=active]:btn-hero">
                Single Email
              </TabsTrigger>
              <TabsTrigger value="bulk" className="data-[state=active]:btn-hero">
                Bulk Verification
              </TabsTrigger>
            </TabsList>
